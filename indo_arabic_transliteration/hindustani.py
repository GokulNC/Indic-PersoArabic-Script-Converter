...
HINDUSTANI_MAIN_MAP_FILES = ['hindustani_consonants.csv', 'hindustani_vowels.csv']
HINDUSTANI_MISC_MAP_FILES = ['hindustani_numerals.csv', 'hindustani_punctuations.csv']
