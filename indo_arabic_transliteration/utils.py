...
def get_regex_matcher_from_array(array, match_initial_only=False, match_final_only=False):
...
class StringTranslator:
    ...
    '''
    def __init__(self, translation_dict, sort_by_descending_key_length=True, match_initial_only=False, match_final_only=False, support_back_translation=True):

        self.translation_dict = translation_dict
        if sort_by_descending_key_length:
            self.translation_dict = sort_dict_by_descending_length(self.translation_dict)
        self.regex = get_regex_matcher_from_array(self.translation_dict, match_initial_only, match_final_only)
        ...
        if support_back_translation:
            ...
            self.reverse_regex = get_regex_matcher_from_array(self.reverse_translation_dict, match_initial_only, match_final_only)
